...
from models import UsageTracking, ConversionHistory, SystemSettings, db
...
def index():
    ...
    if current_user.is_authenticated:
        ...
        user_context['usage'] = {
            ...
            'percentage': (today_usage.conversions_count / 5 * 100) if not current_user.is_premium() else 0,
    ...
    return render_template('index.html',
                         ...
                         show_upgrade_prompt=current_user.is_authenticated and not current_user.is_premium())
...
def api_usage_update():
    ...
    return jsonify({
        ...
        'can_convert': current_user.can_convert(),
        'time_until_reset': _get_time_until_reset(),
        'quota_exceeded': today_usage.conversions_count >= 5 and not current_user.is_premium()
    })
